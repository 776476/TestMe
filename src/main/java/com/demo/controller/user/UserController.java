...
public class UserController {
    ...
    public void updateUser(String userName, String userID, String passwordNew, String email, String phone,
            MultipartFile picture, HttpServletRequest request, HttpServletResponse response) throws Exception {
