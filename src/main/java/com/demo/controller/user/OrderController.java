...
public class OrderController {
    ...
    @ResponseBody
    public List<OrderVo> order_list(@RequestParam(value = "page", defaultValue = "1") int page,
    ...
    public void addOrder(String venueName, String date, String startTime, int hours, HttpServletRequest request,
    ...
    @ResponseBody
    public boolean modifyOrder(String venueName, String date, String startTime, int hours, int orderID,
